...
class create_bus(models.Model):
    busname=models.SlugField(max_length=500 ,blank=False,default="enter")
    ...
    ticket1=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0") 
    ticket2=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0") 
    ticket3=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0") 
    ticket4=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0") 
    ticket5=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0") 
    ticket6=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0") 
    ticket7=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0") 
    ticket8=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0")    
    ticket9=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0") 
    ticket10=models.DecimalField(max_digits=10, decimal_places=2,blank=True,default="0") 
...
class Payment(models.Model):
    ...
    def __str__(self):
        return f"Payment {self.payment_id} - {self.email}"